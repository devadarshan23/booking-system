...
def start():
    ...
    bt=Button(window,text="Admin Login",fg="black",bg="white",command=Admin_id)
    bt['font'] = myFont
...
def update_chart():
    ...
    def check():       
            ...
            for a in roeo :
                if w%2==0:                    
                    if checkname.get()==a[1]:                                                                               
                        ...
                        but1['font'] = myFont
                        but2=Button(ther,text="Back",fg="yellow",bg="Blue",command=start)
        ...
        but1.place(relx = 0.35, rely = 0.6, anchor = 'c')
        but1['font'] = myFont
        but2=Button(the,text="Back",fg="yellow",bg="Blue",command=the.destroy)
        but2.place(relx = 0.55, rely = 0.6, anchor = 'c')
        but2['font'] = myFont
...
def put_chart():
    ...
    def puttingchart():
        ...
        def appendit():
            ...
            but1.place(relx = 0.9, rely = 0.1, anchor = 'c')
            but1['font']=myFont
...
def cancel_a_Vehicle():
    ...
    def cancelvehicle():
        ...
        but1['font']=myFont
        but2=Button(cv,text="Back",fg="yellow",bg="Blue",command=start)
...
def Roadways_booking():
    ...
    ld.configure(fg="White",bg="Blue")
    day=ttk.Combobox(windowr,values=vai)
    day.place(relx = 0.7, rely = 0.4, anchor = 'c')
    day.current()
    l3=Label(windowr,text='Month:',font=("Arial Bold",20))
    ...
    month=ttk.Combobox(windowr,values=['January','February','March',
                                       ...
                                       'August','September','October',
                                       'November','December'])
    month.place(relx = 0.8, rely = 0.4, anchor = 'c')
    month.current()
    l4=Label(windowr,text='Year:',font=("Arial Bold",20))
    l4.place(relx = 0.85, rely = 0.35)
    l4.configure(fg="White",bg="Blue")
    year=ttk.Combobox(windowr,values=['2020','2021','2022'])
    year.place(relx = 0.9, rely = 0.4, anchor = 'c')
    year.current()
...
def Guest_Airways():
    ...
    bt=Button(windowA,text="Back",fg="White",bg="Black",command=start)
