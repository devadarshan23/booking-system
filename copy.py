...
def cancel_a_Vehicle():
    ...
    def cancelvehicle():
        ...
        if abc==0:
            ...
            but1['font']=myFont
            but2=Button(cv,text="Back",fg="white",bg="black",command=start1)
    ...
    but1.place(relx = 0.35, rely = 0.6, anchor = 'c')
    but1['font']=myFont
    but2=Button(ca1v,text="Back",fg="white",bg="black",command=start1)
    but2.place(relx = 0.55, rely = 0.6, anchor = 'c')
    but2['font']=myFont
...
def showpaslist():
    ...
    but1=Button(paslist,text="Back",fg="White",bg="Black",command=start1)
...
def Railways_booking():    
    ...
    bt['font']=myFont
    bt2=Button(windowRa,text="Search",fg="White",bg="Black",command=searchpannalama)
...
def Airways_booking():
    ...
    def banking():
        ...
        def bill():
            ...
            j.place(relx=0.01,rely=0.20)
            k=Label(bil,text=available[0][0],font=("arial bold",19),bg="light blue",fg="black")#works only when one flight available
            k.place(relx=0.16,rely=0.20)
        ...
        for j in range (11):          
            if e2==j:
                for i in range(j):
                    ...
                    Class.configure(fg="White",bg="Black")
    ...
    bt.place(relx=0.1,rely=0.88)
    bt['font']=myFont
    bt2=Button(windowAa,text="Search",fg="White",bg="Black",command=searchpannalama)
    bt2.place(relx=0.5,rely=0.9,anchor="c")
    bt2['font']=myFont
...
def Roadways_booking():
    ...
    def banking():
        ...
        for i in range(s):        
            op=0
            if re[i]<=13  or  re[i]>=60 :
                if clas=="A/C Sleeper":             #'A/C Sleeper','A/C Non sleeper','Non A/C Sleeper','Non A/C Non Sleeper'
                    op+=1000
                    c+=op
                    print(c)
